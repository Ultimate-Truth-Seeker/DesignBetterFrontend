        ...
        <div className="grid gap-y-4">
          ...
          <div>
            <div className="flex flex-wrap justify-between items-center gap-2">
              ...
              <a className="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500" href="/forgot-password">Forgot password?</a>
            </div>
            <div className="relative">
